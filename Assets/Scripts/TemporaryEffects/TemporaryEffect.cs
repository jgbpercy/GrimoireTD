...
{
    public class TemporaryEffect : IFrameUpdatee, IReadOnlyTemporaryEffect
    {
        ...
        public TemporaryEffect(object key, float magnitude, float duration, string effectName, Action onEndCallback)
        {
            Key = key;
            Magnitude = magnitude;
            Duration = duration;
