...
public class MapLoader : MonoBehaviour {
    ...
    //private MeshRenderer offMapGraphicsRenderer;
    ...
    private void Awake()
    {
        ...
        if (debugOn) Debug.Log("MapLoader Received MapData");
    }

    private void Start () {

        /*mapGraphicsCollider = gameObject.GetComponentInChildren<MeshCollider>();
        mapGraphicsFilter = gameObject.GetComponentInChildren<MeshFilter>();
        mapGraphicsRenderer = gameObject.GetComponentInChildren<MeshRenderer>();

        offMapGraphicsFilter = GameObject.Find("OffMapGraphics").GetComponent<MeshFilter>();*/
    ...
    private void InitialiseOffMap()
    {
        ...
        offMapGraphicsFilter.transform.position = new Vector3(-2 * MapLoader.HEX_OFFSET * offMapHexThickness, -0.75f * offMapHexThickness, 0f);
    }
