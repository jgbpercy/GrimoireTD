...
public class CameraManager : MonoBehaviour {
    ...
    [SerializeField]
    private float cameraTileClampMax;
    [SerializeField]
    ...
    void Start () {
        ...
        //camera clamps
        cameraRightClamp = mapLoader.Map.Width * MapLoader.HEX_OFFSET * 2;
        cameraTopClamp = mapLoader.Map.Height * 0.75f;
    }
    ...
    {
        cameraTiltTarget = Mathf.Clamp(cameraTiltTarget + Input.GetAxis("CameraTilt") * cameraTiltSpeed * Time.deltaTime, cameraTiltClampMin, cameraTileClampMax);
